...
class RolePermissionController extends Controller
{
     ...
     * @var string $folder 
     */
    protected $folder = 'role-permission';
    ...
    {
        $model = [];
        return view('admin.'.$this->folder.'.create', compact('model'));
    }
    ...
    {
        $model = model::findOrFail($id);
        return view('admin.'.$this->folder.'.edit', compact('model'));
    }
